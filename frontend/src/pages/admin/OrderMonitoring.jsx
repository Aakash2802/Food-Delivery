  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Live Order Monitoring</h1>
          <p className="text-gray-600">Monitor all active orders in real-time</p>
        </div>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  ...
                  <div className="p-4 bg-green-50 rounded-lg">
                    ...
                    {order.driverId ? (
                      <>
                        <p className="font-medium text-gray-900">{order.driverId.name}</p>
