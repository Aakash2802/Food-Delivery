    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 animate-fade-in">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="bg-white text-gray-700 px-6 py-3 rounded-xl font-semibold hover:bg-gray-50 transition-all shadow-md"
            >
              Back to Dashboard
            </button>
          </div>
          ...
          {/* Filter Tabs */}
          <div className="flex space-x-4 bg-white rounded-xl p-2 shadow-md">
            {[
        ...
        {restaurants.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-lg p-16 text-center animate-fade-in">
          ...
          <div className="grid grid-cols-1 gap-6">
            {restaurants.map((restaurant, index) => (
              <div
                key={restaurant._id}
                className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 animate-scale-in"
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center space-x-4">
                        {restaurant.images?.[0] ? (
                          ...
                          <div className="w-20 h-20 rounded-xl bg-gradient-to-br from-red-100 to-orange-100 flex items-center justify-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-sm text-gray-600">
                          <strong>Cuisine:</strong> {restaurant.cuisineType?.join(', ') || 'N/A'}
                        </div>
                        <div className="text-sm text-gray-600">
                          <strong>Delivery Time:</strong> {restaurant.deliveryTime?.min || 0} - {restaurant.deliveryTime?.max || 0} mins
                        </div>
                        <div className="text-sm text-gray-600">
                          <strong>Min Order:</strong> ₹{restaurant.minimumOrder || 0}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 mb-4">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm text-gray-600">
                        <div>
                          <strong>Name:</strong> {restaurant.ownerId?.name || 'N/A'}
                        </div>
                        <div>
                          <strong>Email:</strong> {restaurant.ownerId?.email || 'N/A'}
                        </div>
                      </div>
                    </div>
