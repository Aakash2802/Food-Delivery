        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          {stats ? (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Overall Rating */}
              <div className="flex flex-col items-center justify-center bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-8 border-2 border-yellow-200">
              ...
              <div className="space-y-4">
                <h3 className="font-bold text-gray-900 text-lg mb-4">Rating Distribution</h3>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-200">
                  <p className="text-sm text-gray-600 mb-2">Delivery Service</p>
                  <div className="flex items-center space-x-2">
                    <span className="text-3xl font-bold text-gray-900">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
                  <p className="text-sm text-gray-600 mb-2">Helpful Reviews</p>
                  <div className="flex items-center space-x-2">
          ...
          {loading ? (
            ...
            reviews.map((review) => (
              ...
              >
                ...
                {/* Ratings Breakdown */}
                <div className="flex flex-wrap gap-6 mb-4 bg-gray-50 rounded-xl p-4">
                  <div>
                    <span className="text-xs text-gray-600 font-medium">Food Quality</span>
                ...
                {review.restaurantResponse?.comment ? (
                  <div className="mt-4 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 border-l-4 border-purple-500">
        ...
        {reviews.length > 0 && (
          <div className="flex justify-center gap-3 mt-8">
            <button
              ...
              disabled={page === 1}
              className="px-6 py-3 rounded-xl bg-white text-gray-700 font-semibold hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-md"
            >
              Previous
            </button>
            <span className="px-6 py-3 text-gray-700 font-semibold bg-white rounded-xl shadow-md">
              Page {page}
            </span>
            <button
